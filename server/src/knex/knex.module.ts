...
import { KnexOptions, KnexAsyncOptions, KnexOptionsFactory } from './interfaces';
...
export class KnexModule {
    ...
    private static createOptionsProvider(options: KnexAsyncOptions): Provider {
        ...
        return {
            provide: KNEX_OPTIONS,
            useFactory: async (optionsFactory: KnexOptionsFactory) => await optionsFactory.createKnexOptions(),
